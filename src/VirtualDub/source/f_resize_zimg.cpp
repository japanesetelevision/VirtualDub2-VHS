...
public:
	...
	virtual void StartAccel(IVDXAContext *vdxa) override;
	virtual void StopAccel(IVDXAContext *vdxa) override;
	virtual void RunAccel(IVDXAContext *vdxa) override;
...
void VDVideoFilterResizeZimg::StartAccel(IVDXAContext *vdxa) {
...
void VDVideoFilterResizeZimg::StopAccel(IVDXAContext *vdxa) {
...
void VDVideoFilterResizeZimg::RunAccel(IVDXAContext *vdxa) {
	const int x1 = VDCeilToInt(mConfig.mDstRect.left   - 0.5f);
	const int y1 = VDCeilToInt(mConfig.mDstRect.top    - 0.5f);
	const int x2 = VDCeilToInt(mConfig.mDstRect.right  - 0.5f);
	const int y2 = VDCeilToInt(mConfig.mDstRect.bottom - 0.5f);
